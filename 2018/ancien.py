            ...
            for car in self.fleet:
                ...
                if car.available_time <= time:
                    ...
                    if best:
                        ...
                        self.rides_list[best["id"]].done = 0
                        scores += best["score"]
                        ...
                        #print([ride.done for ride in self.rides_list])
                        
                        if sum(ride.done for ride in self.rides_list) == 0 or sum(ride.done for ride in self.rides_list) <= 16 :
                            time = time + self.T
